...
const OFFICIAL_EXTERNAL_RESOURCES = [
    ...
    // ════════════════════════════════════════════════════════════════════
    {
        ...
        courseColor: '#a855f7',
        title: 'Autodesk Tinkercad: Laboratorio y Simulación Virtual de Circuitos',
        source: 'Autodesk Tinkercad',
        sourceType: 'Simulador 3D y Circuitos',
        description: 'Plataforma oficial en la nube para diseñar circuitos con placas Arduino Uno, protoboards interactivas, componentes electrónicos, actuadores y modelado de piezas mecánicas en 3D.',
        category: 'simulators',
        type: 'Simulador',
    ...
    },
    {
        ...
        courseName: 'Robótica Educativa',
        courseColor: '#a855f7',
        title: '01   Control de un LED con C++',
        source: 'Prof. Ronny Martinez',
        sourceType: 'YouTube Oficial',
        description: 'Fundamentos de programación en C++ para microcontroladores: configuración de pines digitales como salida y control de encendido/apagado de un LED con Arduino.',
        category: 'videos',
        type: 'YouTube',
        url: 'https://www.youtube.com/watch?v=vQbSGJRJoJ8',
        videoId: 'vQbSGJRJoJ8',
        tags: ['Control LED', 'C++', 'Arduino Uno', 'Prof. Ronny Martinez', 'Salidas Digitales']
    },
    {
        id: 're-vid-rm-2',
        courseId: 5,
        ...
        courseName: 'Robótica Educativa',
        courseColor: '#a855f7',
        title: '02   Variable int',
        source: 'Prof. Ronny Martinez',
        sourceType: 'YouTube Oficial',
        description: 'Declaración, asignación y gestión de variables de tipo entero (int) en C++ para estructurar código modular, limpio y escalable en proyectos de robótica.',
        category: 'videos',
        type: 'YouTube',
    ...
    },
    {
        ...
        courseName: 'Robótica Educativa',
        courseColor: '#a855f7',
        title: '03   Monitor en serie',
        source: 'Prof. Ronny Martinez',
        sourceType: 'YouTube Oficial',
        description: 'Uso del puerto serie (Serial.begin, Serial.println) para depuración en vivo, diagnóstico de código y telemetría de datos en tiempo real desde el microcontrolador.',
        category: 'videos',
        type: 'YouTube',
    ...
    },
    {
        ...
        courseName: 'Robótica Educativa',
        courseColor: '#a855f7',
        title: '04   Control dos LED con C++',
        source: 'Prof. Ronny Martinez',
        sourceType: 'YouTube Oficial',
